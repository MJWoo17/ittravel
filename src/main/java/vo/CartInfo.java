...
public class CartInfo {
	...
	String shop_bas_prod_name;
	int shop_bas_prod_quantity;
	...
	public void setShop_bas_prod_num(int shop_bas_prod_num) {
		this.shop_bas_prod_num = shop_bas_prod_num;
	}
	public String getShop_bas_prod_name() {
		return shop_bas_prod_name;
	}
	public void setShop_bas_prod_name(String shop_bas_prod_name) {
		this.shop_bas_prod_name = shop_bas_prod_name;
	}
	public int getShop_bas_prod_quantity() {
		return shop_bas_prod_quantity;
	}
	public void setShop_bas_prod_quantity(int shop_bas_prod_quantity) {
		this.shop_bas_prod_quantity = shop_bas_prod_quantity;
	}
	public int getShop_bas_prod_price() {
		return shop_bas_prod_price;
	}
	public void setShop_bas_prod_price(int shop_bas_prod_price) {
		this.shop_bas_prod_price = shop_bas_prod_price;
	}
	public String getShop_bas_mem_id() {
		return shop_bas_mem_id;
	}
	public void setShop_bas_mem_id(String shop_bas_mem_id) {
		this.shop_bas_mem_id = shop_bas_mem_id;
	}
